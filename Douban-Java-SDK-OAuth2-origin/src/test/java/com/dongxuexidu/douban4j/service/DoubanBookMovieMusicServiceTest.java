...
public class DoubanBookMovieMusicServiceTest extends TestCase {
    ...
    public void testGetBookInfoById() throws Exception {
        ...
        //OassertEquals(result.getTitle(), "世间的名字");
    }
    ...
    public void testSearchBook_String_String() throws Exception {
        ...
        for (DoubanSubjectObj d : result.getSubjects()) {
            System.out.println(d.getAuthors().get(0).getName());
            List<DoubanAttributeObj> list = d.getAttributes();
            for (DoubanAttributeObj ss : list) {
                System.out.println(ss.getName());
                System.out.println(ss.getValue());
            }
            List<DoubanLinkObj> list1 = d.getLinks();
            for(DoubanLinkObj ss : list1){
                System.out.println(ss.getHref());
                System.out.println(ss.getRel());
                System.out.println(ss.getObjName());
            }
            //System.out.println(d.getObjName());
            //d.get
