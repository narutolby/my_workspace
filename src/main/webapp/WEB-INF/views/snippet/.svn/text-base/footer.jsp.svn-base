...
<div style="display: none" id="userMark">${userMark}</div>
<div id="footer">
    <div class="footer-l">
        <dl>
            <dt>合作交流</dt>
        ...
        <dl class="friend-link">
            ...
            <dd class="footer-w"><a href="http://www.bupt.edu.cn/" target="_blank">北京邮电大学</a></dd>
            <dd><a href="http://lib.bupt.edu.cn/" target="_blank">北京邮电大学图书馆</a></dd>
            <dd class="footer-w"><a href="http://bbs.byr.cn/index" target="_blank">北邮人论坛</a></dd>
        </dl>
        <dl class="contact">
            <dt>联系方式</dt>
            <dd>邮箱：ehaihong@gmail.com</dd>
            <dd>电话：86-10-62282747</dd>
            <dd>地址：海淀区西土城路10号</dd>
            <dd>传真：86-10-62282747</dd>
        </dl>
    </div>
    <div class="footer-r">
        <p>CopyRight&nbsp;© 2013&nbsp;PCN&CAD中心&nbsp;&&nbsp;北京邮电大学图书馆,&nbsp;&nbsp;京备07019532号&nbsp;All&nbsp;rights&nbsp;reserved.</p>
    </div>
</div>
