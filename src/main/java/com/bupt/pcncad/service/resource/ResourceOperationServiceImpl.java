...
public class ResourceOperationServiceImpl implements IResourceOperationService {
    ...
    public List<ResourceSizeUtil> getAllResource() throws Exception{
        List<Resource> resources = this.resourceDao.findAll();

        Iterator it = resources.iterator();
        List<ResourceSizeUtil> resourcelist = new ArrayList<ResourceSizeUtil>();
        while(it.hasNext()){
            ...
            resourcelist.add(resourceSizeUtil);
        }
        return resourcelist;
    }
}
