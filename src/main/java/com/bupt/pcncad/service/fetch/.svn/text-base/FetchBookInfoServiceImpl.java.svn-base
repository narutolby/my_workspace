...
public class FetchBookInfoServiceImpl implements IFetchBookInfoService {
    ...
    public List<HotBook> getAllHotBooks(int flag) throws Exception {
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(HotBook.class);
        detachedCriteria.add(Restrictions.eq("flag",flag));
        long count = this.bookInfoDao.getCount(detachedCriteria);
        detachedCriteria.setProjection(null);
        return this.bookInfoDao.findByDetachedCriteria(detachedCriteria, (int)count-30,30);
